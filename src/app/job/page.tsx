        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm sm:text-base text-green-100">Công việc</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm sm:text-base text-green-100">Lĩnh vực</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col w-1/4">
          <Card className="sticky top-4">
            <CardHeader>
              ...
              <CardDescription>Lọc công việc theo tiêu chí của bạn</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-green-600">{searchMinSalary.toLocaleString("vi-VN")}₫</span>
                  </div>
                  <div className="flex items-center justify-between text-sm mt-1">
                    <span className="text-gray-600">Đến:</span>
                    <span className="font-medium text-green-600">
                      {(searchMaxSalary === 1000000000 ? 100000000 : searchMaxSalary).toLocaleString("vi-VN")}₫
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Mức lương phổ biến</label>
              ...
              {!isLoading && !isSearching && (
                <div className="pt-2 text-center">
                  <p className="text-sm text-gray-600">
                    Tìm thấy <span className="font-semibold text-green-600">{initialData.length}</span> công việc
                  </p>
                </div>
              )}
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-white/70 backdrop-blur-sm z-10 flex items-center justify-center rounded-lg">
                  <div className="flex items-center gap-2 text-green-600 bg-white px-4 py-2 rounded-full shadow-md">
                    ...
                    <span className="font-medium">Đang cập nhật kết quả...</span>
                  </div>
                </div>
        ...
        <div className="flex flex-col items-center w-1/4 gap-4">
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>Đăng ký nhận thông báo qua email khi có công việc mới phù hợp</CardDescription>
            </CardHeader>
            <CardContent>
              <form className="flex flex-col space-y-4">
                <input type="email" placeholder="Nhập email của bạn" className="p-2 border rounded" required />
